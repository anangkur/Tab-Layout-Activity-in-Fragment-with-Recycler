# TabLayout Activity in FragmentLayout with RecyclerView Template
...
- Copy folder `TabActivityInFragmentWithRecyclerTemplate` to 
...
<img src="https://i.imgur.com/FKUWT2A.png" width="600">

- You will then be prompted to fill in the variables see the example below:
<img src="https://i.imgur.com/nffjZLA.png" width="600">
